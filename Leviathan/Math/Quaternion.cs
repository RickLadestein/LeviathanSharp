...
namespace Leviathan.Math
{
    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        public Vector3f ToEulerAngles()
        {
            ...
            */
            ...
            if (singularityTest > SINGULARITY_THRESHOLD * unit)
            {
                ...
                eulerAngles.Y = System.MathF.PI / 2f;
                eulerAngles.X = 0;
            }
        ...
        public float Length => MathF.Sqrt((W * W) + Xyz.LengthSqr());

        /// <summary>
        /// Gets the square of the quaternion length (magnitude).
        /// </summary>
        public float LengthSquared => (W * W) + Xyz.LengthSqr();
        ...
        public static void FromEulerAngles(in Vector3f eulerAngles, out Quaternion result)
        {
        ...
        public static void ToEulerAngles(in Quaternion q, out Vector3f result)
        {
        ...
        /// <returns>The equivalent quaternion.</returns>
        [Pure]
        public static Quaternion FromMatrix(Mat3 matrix)
        {
        ...
        /// <param name="matrix">A rotation matrix.</param>
        /// <param name="result">The equivalent quaternion.</param>
        public static void FromMatrix(in Mat3 matrix, out Quaternion result)
        {
        ...
        public static Quaternion Slerp(Quaternion q1, Quaternion q2, float blend)
        {
            ...
            var cosHalfAngle = (q1.W * q2.W) + Vector3f.Dot(q1.Xyz, q2.Xyz);
        ...
        [Pure]
        public static Vector4f operator *(Quaternion quat, Vector4f vec)
        {
            Quaternion v = new Quaternion(vec.X, vec.Y, vec.Z, vec.W);
            Quaternion.Invert(in quat, out Quaternion i);
            Quaternion.Multiply(in quat, in v, out Quaternion t);
